...
function Pricing() {
   ...
   return (
      <section id="pricing" className="overflow-hidden">
         <div className="bg-gray-200 md:py-20 py-[60px]">
            <div className="container">
               <h2 className="text-center mb-2.5">Collect your product.</h2>
               <p className="text-center mb-10">
                  Flypro camera is an optical instrument for capturing super
                  images.
               </p>
               <Slider {...settings}>
                     ...
                     <div key={index} className="group">
                        <div className="bg-white text-center mx-2">
                           <div className="relative overflow-hidden z-0">
                              ...
                              <Link
                                 href="/"
                                 className="absolute bottom-4 left-0 right-0 translate-y-24 z-30 group-hover:translate-y-0 duration-300"
                              >
