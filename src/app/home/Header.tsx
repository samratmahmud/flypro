...
function Header() {
  return (
    <section className="relative z-0 bg-header-bg bg-no-repeat bg-cover bg-bottom lg:pt-52 md:pt-44 pt-36 lg:min-h-[650px] min-h-[570px]">
      ...
      <div className="bg-dron-camera absolute -bottom-[200px] bg-no-repeat [background-position:bottom_center] -z-10 w-full h-full animation-bounce"></div>
    </section>
  );
}
